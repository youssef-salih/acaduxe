...
<div className='p-3 mb-2 bg-dark bg-gradient text-white'>.bg-dark.bg-gradient</div>`;
	...
	const VARIABLES = `
$primary:       ${import.meta.env.VITE_REACT_APP_PRIMARY_COLOR};
$secondary:		${import.meta.env.VITE_REACT_APP_SECONDARY_COLOR};
$success:       ${import.meta.env.VITE_REACT_APP_SUCCESS_COLOR};
$info:          ${import.meta.env.VITE_REACT_APP_INFO_COLOR};
$warning:       ${import.meta.env.VITE_REACT_APP_WARNING_COLOR};
$danger:        ${import.meta.env.VITE_REACT_APP_DANGER_COLOR};
$light:         ${import.meta.env.VITE_REACT_APP_LIGHT_COLOR};
$dark:          ${import.meta.env.VITE_REACT_APP_DARK_COLOR};`;
	const VARIABLES_2 = `
