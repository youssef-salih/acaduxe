				...
				data: [
					{
						...
						fillColor: import.meta.env.VITE_REACT_APP_INFO_COLOR,
					},
					{
						x: 'Design',
					...
					},
					{
						...
						fillColor: import.meta.env.VITE_REACT_APP_PRIMARY_COLOR,
					},
					{
						x: 'Testing',
					...
					},
					{
						...
						fillColor: import.meta.env.VITE_REACT_APP_DANGER_COLOR,
					},
				],
			},
		],
