...
const CommonDashboardSalesByStore = () => {
	...
	const companies = [
		{ name: 'Equipe 1', img: Company1 },
		{ name: 'Equipe 2', img: Company2 },
		{ name: 'Equipe 3', img: Company3 },
		{ name: 'Equipe 4', img: Company4 },
	];
	const COMPANIES_TAB = {
	...
	const salesByStoreOptions: ApexOptions = {
		...
		colors: [
			import.meta.env.VITE_REACT_APP_INFO_COLOR,
			import.meta.env.VITE_REACT_APP_SUCCESS_COLOR,
			import.meta.env.VITE_REACT_APP_WARNING_COLOR,
		],
		dataLabels: {
			enabled: false,
		},
		...
		yaxis: [
			{
				...
				axisBorder: {
					show: true,
					color: import.meta.env.VITE_REACT_APP_INFO_COLOR,
				},
				labels: {
					style: {
						colors: import.meta.env.VITE_REACT_APP_INFO_COLOR,
					},
				},
				title: {
			...
			},
			{
				...
				axisBorder: {
					show: true,
					color: import.meta.env.VITE_REACT_APP_SUCCESS_COLOR,
				},
				labels: {
					style: {
			...
			},
			{
				...
				axisBorder: {
					show: true,
					color: import.meta.env.VITE_REACT_APP_WARNING_COLOR,
				},
				labels: {
					style: {
						colors: import.meta.env.VITE_REACT_APP_WARNING_COLOR,
					},
				},
				title: {
