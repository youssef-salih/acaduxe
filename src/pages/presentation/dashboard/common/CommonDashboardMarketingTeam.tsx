...
const CommonDashboardCoachesTeam = () => {
	const { darkModeStatus } = useDarkMode();

	const navigate = useNavigate();
	const handleOnClickToEmployeeListPage = useCallback(() => navigate(`/entraineurs`), [navigate]);
...
export default CommonDashboardCoachesTeam;
